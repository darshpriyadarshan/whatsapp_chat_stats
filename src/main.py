...
class Main:
    ...
    def main(self):
        try:
            ...
            friend1.messages_per_day = math.ceil(friend1.message_count/date_object.total_days)
            friend2.messages_per_day = math.ceil(friend2.message_count/date_object.total_days)
            ...
            print("For finding the longest conversation, we have considered a maximum time gap of 10 minutes between "
                  "adjacent messages")
            print("Longest conversation has {} messages, started at {}, ended at {}".
                  format(date_object.longest_convo_messages,
                         date_object.date_time_list[date_object.longest_convo_start],
            ...
            print("Average number of words per message by {} is {}".format(friend1.name,
                                                                           friend1.average_words_per_message))
            print("Average number of words per message by {} is {}".format(friend2.name,
                                                                           friend2.average_words_per_message))
            ...
            print("Frequently used emojis by {} with description {}".format(friend1.name,
                                                                            friend1.emojis_with_description))
            print("Frequently used emojis by {} with description {}".format(friend2.name,
                                                                            friend2.emojis_with_description))
            ...
            print("Most number of messages were sent at during {} hour of the day. "
                  ...
                  format(date_object.messages_per_hour[0][0], date_object.messages_per_hour[0][1],
                         percent_of_total_messages_hour))
            ...
            print("Most number of messages were sent on {}. "
                  "Total messages on this day are {} which is {}% of total messages".
                  format(date_object.messages_per_day[0][0], date_object.messages_per_day[0][1],
