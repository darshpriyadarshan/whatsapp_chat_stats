...
class Main:
    ...
    def prepare_stats(self, friend1, friend2, date_object):
        try:
            ...
            friend1.name, friend2.name, self.os = names.find_names(self.file_contents)
            ...
            friend1.prepare_messages_list(self.file_contents, self.os)
            friend2.prepare_messages_list(self.file_contents, self.os)
            ...
            date_object.findall_dates(self.file_contents, self.os)
            date_object.findall_date_time(self.file_contents, self.os)
